...
"description": "Thame Town Council is seeking tenders from suitably qualified companies for the design, installation, attendance at switch-on event, maintenance, removal and storage of Christmas lights for Thame. The contractor will need to have a proven and demonstrated experience in similar projects.rnThe contract is for a 5 year period, covering 5 Christmas events and the Council has a maximum budget of Â£95,000 excluding VAT, over the 5 years (Â£19,000 excluding VAT per annum).rnIn order that your company is considered for the supply of these services please ensure you submit your response to the requirements stated in the Invitation to Tender to Supply a Managed Service for Christmas Lighting December 2025 - January 2030.",
...
let CFSearchData37 = Data(ReleaseStr37.utf8)
