...
//    var contractsToSave = cfSearch.releases.filter({$0.isSelected})
//    
//    /// Deselect the contract before saving
//    for index in contractsToSave.indices {
//      contractsToSave[index].isSelected = false
//    }
//    
